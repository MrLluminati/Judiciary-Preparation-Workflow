...
| Current Provisions | Articles 12, 13, 14, 15 completed at basic level; Article 16(1)–16(2) consolidated |
| Current Ladder Status | Day 3 Study Block 2 closed; Block 3 started for light revision only |

## Daily Progress Log

| Day | Date | Topic | Block 1 | Block 2 | Block 3 | Status | Notes |
|---|---|---|---|---|---|---|---|
...
| Day 3 | 2026-05-13 | Constitution: Article 15 revision + Article 16(1)–16(2) | Article 15 revision micro-drill completed; Article 16 terminology focus completed; Article 16(1)–16(2) initial answer completed; Articles 14/15/16 comparison completed | Article 16 consolidation completed; Article 16 short drill completed; Articles 14–16 MCQ drill 10/10; mains skeleton on Articles 14, 15 and 16 completed; error-log updated | Started — light revision only | In progress | Study Block 2 closed. Notebook Article 16 clean consolidation remains to be finalised because the notebook update call failed once and should be retried at day-end wrap-up without interrupting study. |
...
| Article 14 case laws | Needs memorisation: Budhan Choudhry, Ram Krishna Dalmia, E.P. Royappa, Maneka Gandhi |
...
| Article 16(2) grounds | MCQ correct; exact order should still be revised before sleep |
| Mains conclusion writing | New weak area: conclusion drafting for equality-code answers; formula taught: Article 14 broad equality + Article 15 specific non-discrimination + Article 16 employment equality = equality code |

## Day 3 Study Block 3 — Light Revision

### Wednesday — 13.05.2026

Study Block 3 should remain light. No new heavy topic.

Tasks:

1. Revise Article 14 case laws:
   - Budhan Choudhry v. State of Bihar;
   - Ram Krishna Dalmia v. Justice S.R. Tendolkar;
   - E.P. Royappa v. State of Tamil Nadu;
   - Maneka Gandhi v. Union of India.
2. Revise Article 15 clause table:
   - 15(1): citizen, listed grounds;
   - 15(2): access to public places/facilities, wider application;
   - 15(3): women and children;
   - 15(4): SEBC, SC, ST;
   - 15(5): educational admissions except minority institutions;
   - 15(6): EWS.
3. Revise Article 16(2) grounds:
   - religion, race, caste, sex, descent, place of birth, residence, or any of them.
4. Practise one conclusion line:
   - Articles 14, 15 and 16 together form the equality code by ensuring general equality, specific non-discrimination, and equality in public employment.

## Day-End Documentation Backlog

1. Retry Constitution notebook update for Article 16 clean notes.
2. Update Google Sheet dashboard after Block 3 / day-end closure.
3. Set tomorrow's first task: Article 16(3) to 16(6), unless fatigue requires a lighter revision start.

## Next Study Target

**Day 3 — Study Block 3: light revision only.**

No new Article 16 clauses tonight unless energy is very good.
